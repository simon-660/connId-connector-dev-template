...
package com.evolveum.polygon.connector.template.rest;
...
@ConnectorClass(displayNameKey = "connector.gitlab.rest.display", configurationClass = RestConfiguration.class)
public class RestConnector
		implements TestOp, SchemaOp, Connector, CreateOp, DeleteOp, UpdateDeltaOp, SearchOp<Filter>  {

    private static final Log LOGGER = Log.getLog(RestConnector.class);
    ...
    public void init(Configuration cfg) {
        ...
        this.configuration = (RestConfiguration) cfg;
    ...
    public Schema schema() {
        ...
        SchemaBuilder builder = new SchemaBuilder(RestConnector.class);
        // Define schema here
